...
double	sphericity;
double	aplanarity;
double  transverse sphericity
*/


void CommonBDTvars::getSp(TLorentzVector lepton, TLorentzVector met, vecTLorentzVector jets, double &aplanarity, double &sphericity, double &tsphericity) {
	//
	// Aplanarity and sphericity and transverse sphericity
	//
...
double CommonBDTvars::getBestHiggsMass(TLorentzVector lepton, TLorentzVector met, vecTLorentzVector jets, vdouble btag, double &minChi, double &dRbb, TLorentzVector &bjet1, TLorentzVector &bjet2, vecTLorentzVector loose_jets, vdouble loose_btag, double CSVMwp)
{
...
void CommonBDTvars::vect_of_tagged_TLVs(vvdouble jets, vdouble jetCSV, vecTLorentzVector &vect_of_btag_TLVs,double CSVMwp)
{
...
double CommonBDTvars::get_jet_tag_etamax (vvdouble jets, vdouble jetCSV, double CSVMwp)
{
	...
	vect_of_tagged_TLVs(jets, jetCSV, thetags, CSVMwp);
...
double CommonBDTvars::get_tag_tag_etamax (vvdouble jets, vdouble jetCSV, double CSVMwp)
{
...
double CommonBDTvars::study_tops_bb_syst (double MET, double METphi, TLorentzVector &metv, TLorentzVector lepton, vvdouble jets, vdouble csv, double &minChi, double &chi2lepW, double &chi2leptop, double &chi2hadW, double &chi2hadtop, double &mass_lepW, double &mass_leptop, double &mass_hadW, double &mass_hadtop, double &dRbb, double &testquant1, double &testquant2, double &testquant3, double &testquant4, double &testquant5, double &testquant6, double &testquant7, TLorentzVector &b1, TLorentzVector &b2, double CSVMwp)
{
	...
	double bhm = getBestHiggsMass2(lepton, metv, jet_TLVs, csv, minChi, dRbb, bjet1, bjet2, chi2lepW, chi2leptop, chi2hadW, chi2hadtop, mass_lepW, mass_leptop, mass_hadW, mass_hadtop, leptop, hadtop, CSVMwp); // Jon T. version 2
...
double CommonBDTvars::get_median_bb_mass(vvdouble jets, vdouble jetCSV, double CSVMwp)
{
	...
	vect_of_tagged_TLVs(jets, jetCSV, all_btags, CSVMwp);
...
double CommonBDTvars::JetDelta_EtaAvgEta(vvdouble jet_vect_TLV, vdouble jet_CSV, std::string JetorTag, std::string JetorTag_Avg, double CSVMwp )
{
